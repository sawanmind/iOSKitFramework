...
/// UICacheableImageView error object
///
...
public enum UICacheableImageViewError: Error {
    case CallFailed
    case noDataAvailable
    case CorruptedData
}

extension UICacheableImageViewError: LocalizedError {
...
class UICacheableImageView: NSObject {
    ...
    func showWithSpinner(imageView:UIImageView, url:String?, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        self.showSpinner = true
        self.forceDownload = false
        self.desiredImageSize = nil
    ...
    ///   - url: The URL of the image to be downloaded
    ///   - completion: The completion closure when the data are fully downloaded and presented on the image view
    func show(imageView:UIImageView, url:String?, completion: @escaping ( _ error:UICacheableImageViewError?) -> Void) -> Void {
        self.showSpinner = true
        self.forceDownload = false
        self.desiredImageSize = nil
        self.load(imageView: imageView, url: url, defaultImage: nil) {
    ...
    ///   - completion: The completion closure when the data are fully downloaded and presented on the image view
    func showWithSpinner(imageView:UIImageView, url:String?, size:CGSize, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        self.showSpinner = true
        self.forceDownload = false
    ...
    ///   - size: The new scaling size of the image
    ///   - completion: The completion closure when the data are fully downloaded and presented on the image view
    func show(imageView:UIImageView, url:String?, size:CGSize, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        self.showSpinner = false
        self.forceDownload = false
        self.desiredImageSize = size
        self.load(imageView: imageView, url: url, defaultImage: nil) {
    ...
    ///   - size: The new scaling size of the image
    ///   - completion: The completion closure when the data are fully downloaded and presented on the image view
    func showOverrideWithSpinner(imageView:UIImageView, url:String?, size:CGSize, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        self.showSpinner = true
    ...
    ///   - size: The new scaling size of the image
    ///   - completion: The completion closure when the data are fully downloaded and presented on the image view
    func showOverride(imageView:UIImageView, url:String?, size:CGSize, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        self.showSpinner = false
        self.forceDownload = true
        self.desiredImageSize = size
        self.load(imageView: imageView, url: url, defaultImage: nil) {
    ...
    fileprivate func load(imageView:UIImageView, url:String?, defaultImage:String?, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        
        self.setupImageBeforeLoading(imageView: imageView, defaultImage: defaultImage)
        
        if url == nil || url!.isEmpty {
            let error: UICacheableImageViewError = UICacheableImageViewError.CallFailed
            completion(error)
    ...
    private func lazyLoad(imageView:UIImageView, url:String?, completion: @escaping (_ error:UICacheableImageViewError?) -> Void) -> Void {
        ...
        self.fetchImage(url: url) {
            ...
            if finalError == nil {
                ...
                if let img = image {
                    ...
                    finalError = UICacheableImageViewError.CorruptedData
                }
            }
    ...
    func fetchImage(url:String?, completion: @escaping (_ image:UIImage?, _ error:UICacheableImageViewError?) -> Void) -> Void {
            ...
            let task = session.dataTask(with: urlRequest, completionHandler: { (data, response, error) in
                ...
                if response != nil {
                    ...
                    if httpResponse.statusCode != 200 {
                        Swift.debugPrint("UICacheableImageView status code : \(httpResponse.statusCode)")
                ...
                if data == nil {
                    ...
                    Swift.debugPrint("UICacheableImageView: No image data available")
                    
                    //No data available
                    let error: UICacheableImageViewError = UICacheableImageViewError.noDataAvailable
                    completion(nil, error)
                    return
                }
    ...
    func zoom(imageView:UIImageView) -> Void {
        ...
        let tap:UITapGestureRecognizer = UITapGestureRecognizer(target: self, action:#selector(UICacheableImageView.zoomOutImageView(_:)))
